...
CREATE TABLE IF NOT EXISTS products (
    ...
    stock_status   VARCHAR(20)   NOT NULL DEFAULT 'out_of_stock', -- NEW COLUMN
    restock_date   DATE          DEFAULT NULL,                    -- NEW COLUMN
...
BEGIN
    ...
    SELECT stock_status INTO v_old_stock_status FROM products WHERE product_id = p_product_id;
    IF p_stock > 10 THEN
        SET v_stock_status = 'in_stock';
    ELSEIF p_stock BETWEEN 1 AND 10 THEN
        SET v_stock_status = 'low_stock';
    ...
    SET name = p_name, price = p_price, stock = p_stock, rating = p_rating,
        ...
        restock_date = CASE 
            ...
            WHEN v_old_stock_status = 'out_of_stock' AND v_stock_status != 'out_of_stock' THEN NULL
            ELSE restock_date
        END
...
BEGIN
    ...
    DECLARE v_stock_status VARCHAR(20);
    DECLARE v_old_stock_status VARCHAR(20);
    SELECT stock, stock_status INTO v_new_stock, v_old_stock_status FROM products WHERE product_id = p_product_id;
