...
-- ================================================
-- TABLE MIGRATION FOR EXISTING DEPLOYMENTS
-- ================================================
-- ALTER TABLE products ADD COLUMN price_category VARCHAR(10) GENERATED ALWAYS AS (
--     CASE 
--         WHEN price < 1000 THEN 'cheap'
--         WHEN price BETWEEN 1000 AND 5000 THEN 'midrange'
--         ELSE 'expensive'
--     END
-- ) STORED;
-- ALTER TABLE products ADD COLUMN rating DECIMAL(2,1) NOT NULL DEFAULT 0.0;
