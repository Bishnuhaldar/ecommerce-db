...
BEGIN
    ...
    -- If stock_status changes from out_of_stock to something else, set restock_date to NULL
    ...
    ELSE
        UPDATE products SET restock_date = p_restock_date WHERE product_id = p_product_id;
    END IF;
END $$
